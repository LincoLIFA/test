...
<head>
  ...
  <!-- Theme style -->
  <link rel="stylesheet" href="{{ asset('style/docs/dist/css/adminlte.min.css') }}">
  <!-- overlayScrollbars -->
...
<body class="hold-transition sidebar-mini layout-fixed">
  ...
  <!-- AdminLTE App -->
  <script src="{{ asset('style/docs/dist/js/adminlte.min.js')}}"></script>
  <!-- AdminLTE dashboard demo (This is only for demo purposes) -->
  <script src="{{ asset('style/docs/dist/js/pages/dashboard.js') }}"></script>
  <!-- AdminLTE for demo purposes -->
  <script src="{{ asset('style/docs/dist/js/demo.js') }}"></script>
</body>
